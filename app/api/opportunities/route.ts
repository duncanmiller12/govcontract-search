...
import { buildSAMParams, fetchFromSAM } from '@/lib/samgov'
import { getMockOpportunitiesResponse } from '@/lib/mockData'
...
export async function GET(request: NextRequest) {
  ...
  if (!apiKey) {
    const data = getMockOpportunitiesResponse(filters)
